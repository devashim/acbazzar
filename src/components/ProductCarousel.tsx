...
import { ArrowRight, ChevronLeft, ChevronRight, Star, MessageCircle, LucideIcon } from "lucide-react";
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/products">
            <Button variant="ghost" size="sm" className={`gap-1 ${accent === "warm" ? "text-warm hover:text-warm" : "text-cool hover:text-cool-dark"}`}>
            ...
            >
              ...
              <div className="p-3">
                <div className="flex items-center justify-between mb-0.5">
                  <span className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">{product.brand} • {product.capacity}</span>
